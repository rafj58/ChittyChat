...
const (
	ChittyChatService_SendMessage_FullMethodName = "/proto.ChittyChatService/SendMessage"
)
...
func (c *chittyChatServiceClient) SendMessage(ctx context.Context, opts ...grpc.CallOption) (ChittyChatService_SendMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &ChittyChatService_ServiceDesc.Streams[0], ChittyChatService_SendMessage_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
